...
const main = async () => {
    ...
    const movieData = [
        ...
        {
            title: "Hereditary",
            overview: "When the matriarch of the Graham family passes away, her daughter and grandchildren begin to unravel cryptic and increasingly terrifying secrets about their ancestry.",
            releaseYear: 2018,
        ...
        {
            title: "13th",
            overview: "In this thought-provoking documentary, scholars, activists and politicians analyze the intersection of race, justice and mass incarceration in the United States.",
            releaseYear: 2016,
            genres: ["Documentary", "History", "Crime"],
            runtime: 100,
            posterUrl: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600&q=80",
            createdBy: staffId,
        }
    ];
